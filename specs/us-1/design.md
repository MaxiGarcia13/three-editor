...
- `viewport`: R3F `Canvas`, lights, world XYZ axes with metre rulers on +X/+Y (major `Nm` / minor `0.1` ticks; `viewport/constants/world-axes`), OrbitControls, model scene graph once loaded
