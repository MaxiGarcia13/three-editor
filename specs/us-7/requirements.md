...
As an editor user, I can create a new animation from scratch or use an uploaded clip, preview blend/fade with other library clips, and Bake when I want that mix written into the active clip.
...
- [ ] Settings **Blend** is a collapsible; expanded form has partner select, weight, fade, **Bake**, and **Reset**
- [ ] Blend/fade is viewport-only until Bake; Bake writes into the active clip and resets the form; Reset clears without writing
